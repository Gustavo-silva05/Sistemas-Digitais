...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../contador_decimal.gen/sources_1/ip/ila_0_2/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../contador_decimal.gen/sources_1/ip/ila_0_2/hdl/verilog" \
