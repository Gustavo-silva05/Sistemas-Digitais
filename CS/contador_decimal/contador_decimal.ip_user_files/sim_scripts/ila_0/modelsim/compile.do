...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../../contador_decimal.gen/sources_1/ip/ila_0/hdl/verilog" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../contador_decimal.gen/sources_1/ip/ila_0/hdl/verilog" \
